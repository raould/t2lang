...
import { makeMacroEnv, collectMacros } from '../Stage6-macro-env';
import { expandAll, formatExpansionErrors } from '../Stage6-macro-expand';
import { spanTable, resetSpans, nextNodeId, registerSpan } from '../Stage6-spans';
