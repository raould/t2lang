...
import { Stage6Listener } from "./Stage6Listener.js";
// for running tests with parameters, TODO: discuss strategy for typed parameters in CI
// eslint-disable-next-line no-unused-vars
type int = number;


export class Stage6Parser extends antlr.Parser {
    ...
    public get literalNames(): (string | null)[] { return Stage6Parser.literalNames; }
    public get symbolicNames(): (string | null)[] { return Stage6Parser.symbolicNames; }
    public get ruleNames(): string[] { return Stage6Parser.ruleNames; }
    public get serializedATN(): number[] { return Stage6Parser._serializedATN; }
    ...
    public constructor(input: antlr.TokenStream) {
        super(input);
        this.interpreter = new antlr.ParserATNSimulator(this, Stage6Parser._ATN, Stage6Parser.decisionsToDFA, new antlr.PredictionContextCache());
    }
    public program(): ProgramContext {
        let localContext = new ProgramContext(this.context, this.state);
        this.enterRule(localContext, 0, Stage6Parser.RULE_program);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 260;
            this.match(Stage6Parser.LPAREN);
            this.state = 261;
            this.match(Stage6Parser.PROGRAM);
            this.state = 265;
            ...
            this.state = 268;
            this.match(Stage6Parser.RPAREN);
            }
        }
        catch (re) {
    ...
    public topLevel(): TopLevelContext {
        ...
        this.enterRule(localContext, 2, Stage6Parser.RULE_topLevel);
        try {
            this.state = 279;
            this.errorHandler.sync(this);
    ...
    public decl(): DeclContext {
        ...
        this.enterRule(localContext, 4, Stage6Parser.RULE_decl);
        try {
            this.state = 286;
            this.errorHandler.sync(this);
    ...
    public defmacro(): DefmacroContext {
        ...
        this.enterRule(localContext, 6, Stage6Parser.RULE_defmacro);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 289;
            this.match(Stage6Parser.DEFMACRO);
            this.state = 290;
            this.match(Stage6Parser.IDENTIFIER);
            this.state = 291;
            this.fnSignature();
            this.state = 295;
            this.errorHandler.sync(this);
    ...
    public macroTimeFnDef(): MacroTimeFnDefContext {
        ...
        this.enterRule(localContext, 8, Stage6Parser.RULE_macroTimeFnDef);
        try {
            this.state = 310;
            this.errorHandler.sync(this);
            ...
            case 1:
                ...
                this.match(Stage6Parser.LPAREN);
                this.state = 301;
                this.match(Stage6Parser.MACRO_TIME_ATTR);
                this.state = 302;
                this.topLevelLet();
                this.state = 303;
                this.match(Stage6Parser.RPAREN);
    ...
    public topLevelLet(): TopLevelLetContext {
        ...
        this.enterRule(localContext, 10, Stage6Parser.RULE_topLevelLet);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public topLevelConst(): TopLevelConstContext {
        ...
        this.enterRule(localContext, 12, Stage6Parser.RULE_topLevelConst);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public metaAnnotation(): MetaAnnotationContext {
        ...
        this.enterRule(localContext, 14, Stage6Parser.RULE_metaAnnotation);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 336;
            this.match(Stage6Parser.CARET);
            this.state = 337;
            this.match(Stage6Parser.KEYWORD);
            }
        }
        catch (re) {
            if (re instanceof antlr.RecognitionException) {
    ...
    public typeAlias(): TypeAliasContext {
        ...
        this.enterRule(localContext, 16, Stage6Parser.RULE_typeAlias);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 339;
    ...
    public interfaceDef(): InterfaceDefContext {
        ...
        this.enterRule(localContext, 18, Stage6Parser.RULE_interfaceDef);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 348;
            this.match(Stage6Parser.LPAREN);
            this.state = 349;
            this.match(Stage6Parser.INTERFACE);
            this.state = 350;
            this.match(Stage6Parser.IDENTIFIER);
            this.state = 352;
            this.errorHandler.sync(this);
    ...
    public interfaceExtends(): InterfaceExtendsContext {
        ...
        this.enterRule(localContext, 20, Stage6Parser.RULE_interfaceExtends);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 361;
            this.match(Stage6Parser.EXTENDS);
            this.state = 363;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            do {
    ...
    public classDef(): ClassDefContext {
        ...
        this.enterRule(localContext, 22, Stage6Parser.RULE_classDef);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public anonClassDef(): AnonClassDefContext {
        ...
        this.enterRule(localContext, 24, Stage6Parser.RULE_anonClassDef);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public classExtends(): ClassExtendsContext {
        ...
        this.enterRule(localContext, 26, Stage6Parser.RULE_classExtends);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 407;
    ...
    public classImplements(): ClassImplementsContext {
        ...
        this.enterRule(localContext, 28, Stage6Parser.RULE_classImplements);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 413;
            this.match(Stage6Parser.IMPLEMENTS);
            this.state = 415;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            do {
    ...
    public classBody(): ClassBodyContext {
        ...
        this.enterRule(localContext, 30, Stage6Parser.RULE_classBody);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 422;
            this.match(Stage6Parser.CLASS_BODY);
            this.state = 426;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            while (_la === 2) {
    ...
    public classElement(): ClassElementContext {
        ...
        this.enterRule(localContext, 32, Stage6Parser.RULE_classElement);
        try {
            this.state = 437;
            this.errorHandler.sync(this);
    ...
    public modifier(): ModifierContext {
        ...
        this.enterRule(localContext, 34, Stage6Parser.RULE_modifier);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 439;
    ...
    public fieldDef(): FieldDefContext {
        ...
        this.enterRule(localContext, 36, Stage6Parser.RULE_fieldDef);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public constructorDef(): ConstructorDefContext {
        ...
        this.enterRule(localContext, 38, Stage6Parser.RULE_constructorDef);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 460;
            this.match(Stage6Parser.CONSTRUCTOR);
            this.state = 461;
    ...
    public classMethodDef(): ClassMethodDefContext {
        ...
        this.enterRule(localContext, 40, Stage6Parser.RULE_classMethodDef);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 471;
            this.match(Stage6Parser.METHOD);
            this.state = 475;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            while (_la === 103) {
    ...
    public abstractMethodDef(): AbstractMethodDefContext {
        ...
        this.enterRule(localContext, 42, Stage6Parser.RULE_abstractMethodDef);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 489;
            this.match(Stage6Parser.ABSTRACT_METHOD);
            this.state = 493;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            while (_la === 103) {
    ...
    public getterDef(): GetterDefContext {
        ...
        this.enterRule(localContext, 44, Stage6Parser.RULE_getterDef);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public setterDef(): SetterDefContext {
        ...
        this.enterRule(localContext, 46, Stage6Parser.RULE_setterDef);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 519;
            this.match(Stage6Parser.SETPROP);
            this.state = 523;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            while (_la === 103) {
    ...
    public typedParam(): TypedParamContext {
        ...
        this.enterRule(localContext, 48, Stage6Parser.RULE_typedParam);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            if (_la === 78) {
                {
                this.state = 538;
                this.match(Stage6Parser.OPTIONAL);
                }
            }
    ...
    public fnSignatureTyped(): FnSignatureTypedContext {
        ...
        this.enterRule(localContext, 50, Stage6Parser.RULE_fnSignatureTyped);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            case 1:
                ...
                this.match(Stage6Parser.LPAREN);
                this.state = 562;
                this.match(Stage6Parser.RETURNS);
                this.state = 563;
                this.typeExpr();
                this.state = 564;
                this.match(Stage6Parser.RPAREN);
    ...
    public statement(): StatementContext {
        ...
        this.enterRule(localContext, 52, Stage6Parser.RULE_statement);
        try {
            this.state = 587;
            this.errorHandler.sync(this);
    ...
    public letStar(): LetStarContext {
        ...
        this.enterRule(localContext, 54, Stage6Parser.RULE_letStar);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 590;
            this.match(Stage6Parser.LETSTAR);
            this.state = 591;
            this.match(Stage6Parser.LPAREN);
            this.state = 595;
            this.errorHandler.sync(this);
    ...
    public letStmt(): LetStmtContext {
        ...
        this.enterRule(localContext, 56, Stage6Parser.RULE_letStmt);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 607;
    ...
    public constStar(): ConstStarContext {
        ...
        this.enterRule(localContext, 58, Stage6Parser.RULE_constStar);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 614;
            this.match(Stage6Parser.CONSTSTAR);
            this.state = 615;
            this.match(Stage6Parser.LPAREN);
            this.state = 619;
            this.errorHandler.sync(this);
    ...
    public constStmt(): ConstStmtContext {
        ...
        this.enterRule(localContext, 60, Stage6Parser.RULE_constStmt);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 631;
    ...
    public ifForm(): IfFormContext {
        ...
        this.enterRule(localContext, 62, Stage6Parser.RULE_ifForm);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public whileForm(): WhileFormContext {
        ...
        this.enterRule(localContext, 64, Stage6Parser.RULE_whileForm);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public block(): BlockContext {
        ...
        this.enterRule(localContext, 66, Stage6Parser.RULE_block);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public returnForm(): ReturnFormContext {
        ...
        this.enterRule(localContext, 68, Stage6Parser.RULE_returnForm);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 668;
            this.match(Stage6Parser.RETURN);
            this.state = 670;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            if (_la === 2 || ((((_la - 52)) & ~0x1F) === 0 && ((1 << (_la - 52)) & 939524099) !== 0) || ((((_la - 103)) & ~0x1F) === 0 && ((1 << (_la - 103)) & 23) !== 0)) {
    ...
    public throwForm(): ThrowFormContext {
        ...
        this.enterRule(localContext, 70, Stage6Parser.RULE_throwForm);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 674;
    ...
    public importForm(): ImportFormContext {
        ...
        this.enterRule(localContext, 72, Stage6Parser.RULE_importForm);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 680;
            this.match(Stage6Parser.IMPORT);
            this.state = 682;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            if (_la === 2) {
            ...
            this.state = 684;
            this.match(Stage6Parser.STRING);
            this.state = 685;
            this.match(Stage6Parser.RPAREN);
            }
        }
    ...
    public importTypeForm(): ImportTypeFormContext {
        ...
        this.enterRule(localContext, 74, Stage6Parser.RULE_importTypeForm);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 687;
            this.match(Stage6Parser.LPAREN);
            this.state = 688;
            this.match(Stage6Parser.IMPORT_TYPE);
            this.state = 689;
            this.importTypeSpec();
            this.state = 690;
            this.match(Stage6Parser.STRING);
    ...
    public importTypeSpec(): ImportTypeSpecContext {
        ...
        this.enterRule(localContext, 76, Stage6Parser.RULE_importTypeSpec);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public importTypeName(): ImportTypeNameContext {
        ...
        this.enterRule(localContext, 78, Stage6Parser.RULE_importTypeName);
        try {
            this.state = 707;
            this.errorHandler.sync(this);
            switch (this.tokenStream.LA(1)) {
            case Stage6Parser.IDENTIFIER:
                this.enterOuterAlt(localContext, 1);
                {
                this.state = 702;
                this.match(Stage6Parser.IDENTIFIER);
    ...
    public exportForm(): ExportFormContext {
        ...
        this.enterRule(localContext, 80, Stage6Parser.RULE_exportForm);
        try {
            this.state = 718;
            this.errorHandler.sync(this);
    ...
    public exportBinding(): ExportBindingContext {
        ...
        this.enterRule(localContext, 82, Stage6Parser.RULE_exportBinding);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 720;
            this.match(Stage6Parser.LPAREN);
            this.state = 721;
            this.match(Stage6Parser.EXPORT);
            this.state = 722;
            this.match(Stage6Parser.IDENTIFIER);
            this.state = 723;
            this.expression();
    ...
    public exportDefault(): ExportDefaultContext {
        ...
        this.enterRule(localContext, 84, Stage6Parser.RULE_exportDefault);
        try {
            this.state = 751;
            this.errorHandler.sync(this);
            ...
            case 1:
                ...
                this.match(Stage6Parser.LPAREN);
                this.state = 727;
                this.match(Stage6Parser.EXPORT_DEFAULT);
                this.state = 728;
                this.classDef();
                this.state = 729;
                this.match(Stage6Parser.RPAREN);
    ...
    public exportNamed(): ExportNamedContext {
        ...
        this.enterRule(localContext, 86, Stage6Parser.RULE_exportNamed);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 754;
            this.match(Stage6Parser.EXPORT_NAMED);
            this.state = 756;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            do {
    ...
    public exportNamePair(): ExportNamePairContext {
        ...
        this.enterRule(localContext, 88, Stage6Parser.RULE_exportNamePair);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public exportFrom(): ExportFromContext {
        ...
        this.enterRule(localContext, 90, Stage6Parser.RULE_exportFrom);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 770;
            this.match(Stage6Parser.EXPORT_FROM);
            this.state = 771;
            this.match(Stage6Parser.STRING);
            this.state = 773;
            this.errorHandler.sync(this);
    ...
    public exportAllFrom(): ExportAllFromContext {
        ...
        this.enterRule(localContext, 92, Stage6Parser.RULE_exportAllFrom);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 779;
            this.match(Stage6Parser.LPAREN);
            this.state = 780;
            this.match(Stage6Parser.EXPORT_ALL_FROM);
            this.state = 781;
            this.match(Stage6Parser.STRING);
            this.state = 782;
            this.match(Stage6Parser.RPAREN);
    ...
    public exportNsFromForm(): ExportNsFromFormContext {
        ...
        this.enterRule(localContext, 94, Stage6Parser.RULE_exportNsFromForm);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 784;
            this.match(Stage6Parser.LPAREN);
            this.state = 785;
            this.match(Stage6Parser.EXPORT_NS_FROM);
            this.state = 786;
            this.match(Stage6Parser.STRING);
            this.state = 787;
            this.match(Stage6Parser.STRING);
    ...
    public exportTypeForm(): ExportTypeFormContext {
        ...
        this.enterRule(localContext, 96, Stage6Parser.RULE_exportTypeForm);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 791;
            this.match(Stage6Parser.EXPORT_TYPE);
            this.state = 793;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            do {
    ...
    public exportTypeFromForm(): ExportTypeFromFormContext {
        ...
        this.enterRule(localContext, 98, Stage6Parser.RULE_exportTypeFromForm);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 800;
            this.match(Stage6Parser.EXPORT_TYPE_FROM);
            this.state = 801;
            this.match(Stage6Parser.STRING);
            this.state = 803;
            this.errorHandler.sync(this);
    ...
    public exportTypeAllFromForm(): ExportTypeAllFromFormContext {
        ...
        this.enterRule(localContext, 100, Stage6Parser.RULE_exportTypeAllFromForm);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 809;
            this.match(Stage6Parser.LPAREN);
            this.state = 810;
            this.match(Stage6Parser.EXPORT_TYPE_ALL_FROM);
            this.state = 811;
            this.match(Stage6Parser.STRING);
            this.state = 812;
            this.match(Stage6Parser.RPAREN);
    ...
    public exportDeclForm(): ExportDeclFormContext {
        ...
        this.enterRule(localContext, 102, Stage6Parser.RULE_exportDeclForm);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 814;
    ...
    public starBinding(): StarBindingContext {
        ...
        this.enterRule(localContext, 104, Stage6Parser.RULE_starBinding);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public singleBinding(): SingleBindingContext {
        ...
        this.enterRule(localContext, 106, Stage6Parser.RULE_singleBinding);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public typeExpr(): TypeExprContext {
        ...
        this.enterRule(localContext, 108, Stage6Parser.RULE_typeExpr);
        try {
            this.state = 852;
            this.errorHandler.sync(this);
    ...
    public typeUnion(): TypeUnionContext {
        ...
        this.enterRule(localContext, 110, Stage6Parser.RULE_typeUnion);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public typeIntersection(): TypeIntersectionContext {
        ...
        this.enterRule(localContext, 112, Stage6Parser.RULE_typeIntersection);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 865;
            this.match(Stage6Parser.INTERSECT);
            this.state = 866;
            this.typeExpr();
            this.state = 868;
            this.errorHandler.sync(this);
    ...
    public typeArray(): TypeArrayContext {
        ...
        this.enterRule(localContext, 114, Stage6Parser.RULE_typeArray);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 874;
            this.match(Stage6Parser.LPAREN);
            this.state = 875;
            this.match(Stage6Parser.TYPE_ARRAY);
            this.state = 876;
            this.typeExpr();
            this.state = 877;
            this.match(Stage6Parser.RPAREN);
    ...
    public typeTuple(): TypeTupleContext {
        ...
        this.enterRule(localContext, 116, Stage6Parser.RULE_typeTuple);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public typeTupleElement(): TypeTupleElementContext {
        ...
        this.enterRule(localContext, 118, Stage6Parser.RULE_typeTupleElement);
        try {
            this.state = 899;
            this.errorHandler.sync(this);
    ...
    public typeFunction(): TypeFunctionContext {
        ...
        this.enterRule(localContext, 120, Stage6Parser.RULE_typeFunction);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 902;
            this.match(Stage6Parser.TYPEFN);
            this.state = 904;
            this.errorHandler.sync(this);
    ...
    public typeFnParam(): TypeFnParamContext {
        ...
        this.enterRule(localContext, 122, Stage6Parser.RULE_typeFnParam);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public typeObject(): TypeObjectContext {
        ...
        this.enterRule(localContext, 124, Stage6Parser.RULE_typeObject);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public typeProp(): TypePropContext {
        ...
        this.enterRule(localContext, 126, Stage6Parser.RULE_typeProp);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public propModifier(): PropModifierContext {
        ...
        this.enterRule(localContext, 128, Stage6Parser.RULE_propModifier);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 949;
            this.match(Stage6Parser.READONLY);
            }
        }
        catch (re) {
            if (re instanceof antlr.RecognitionException) {
    ...
    public typeLiteral(): TypeLiteralContext {
        ...
        this.enterRule(localContext, 130, Stage6Parser.RULE_typeLiteral);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public typeKeyof(): TypeKeyofContext {
        ...
        this.enterRule(localContext, 132, Stage6Parser.RULE_typeKeyof);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 956;
    ...
    public typeTypeof(): TypeTypeofContext {
        ...
        this.enterRule(localContext, 134, Stage6Parser.RULE_typeTypeof);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 961;
            this.match(Stage6Parser.LPAREN);
            this.state = 962;
            this.match(Stage6Parser.TYPEOF);
            this.state = 963;
            this.match(Stage6Parser.IDENTIFIER);
            this.state = 964;
            this.match(Stage6Parser.RPAREN);
    ...
    public typeIndexAccess(): TypeIndexAccessContext {
        ...
        this.enterRule(localContext, 136, Stage6Parser.RULE_typeIndexAccess);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 966;
    ...
    public typeConditional(): TypeConditionalContext {
        ...
        this.enterRule(localContext, 138, Stage6Parser.RULE_typeConditional);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 972;
    ...
    public typeInfer(): TypeInferContext {
        ...
        this.enterRule(localContext, 140, Stage6Parser.RULE_typeInfer);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 980;
    ...
    public typeMapped(): TypeMappedContext {
        ...
        this.enterRule(localContext, 142, Stage6Parser.RULE_typeMapped);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 985;
            this.match(Stage6Parser.LPAREN);
            this.state = 986;
            this.match(Stage6Parser.MAPPED);
            this.state = 987;
            this.match(Stage6Parser.IDENTIFIER);
            this.state = 988;
            this.typeExpr();
    ...
    public mappedModifiers(): MappedModifiersContext {
        ...
        this.enterRule(localContext, 144, Stage6Parser.RULE_mappedModifiers);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 996;
            this.match(Stage6Parser.MODIFIERS);
            this.state = 998;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            do {
    ...
    public mappedModifier(): MappedModifierContext {
        ...
        this.enterRule(localContext, 146, Stage6Parser.RULE_mappedModifier);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public typeTemplateLiteral(): TypeTemplateLiteralContext {
        ...
        this.enterRule(localContext, 148, Stage6Parser.RULE_typeTemplateLiteral);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1007;
            this.match(Stage6Parser.TYPE_TEMPLATE);
            this.state = 1009;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            do {
    ...
    public templatePart(): TemplatePartContext {
        ...
        this.enterRule(localContext, 150, Stage6Parser.RULE_templatePart);
        try {
            this.state = 1017;
            this.errorHandler.sync(this);
            switch (this.tokenStream.LA(1)) {
            case Stage6Parser.STRING:
                this.enterOuterAlt(localContext, 1);
                {
                this.state = 1015;
                this.match(Stage6Parser.STRING);
    ...
    public typeApplication(): TypeApplicationContext {
        ...
        this.enterRule(localContext, 152, Stage6Parser.RULE_typeApplication);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public typeParams(): TypeParamsContext {
        ...
        this.enterRule(localContext, 154, Stage6Parser.RULE_typeParams);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1029;
            this.match(Stage6Parser.TYPE_PARAMS);
            this.state = 1031;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            do {
    ...
    public typeParamDecl(): TypeParamDeclContext {
        ...
        this.enterRule(localContext, 156, Stage6Parser.RULE_typeParamDecl);
        let _la: number;
        try {
            this.state = 1047;
            this.errorHandler.sync(this);
    ...
    public typeParamConstraint(): TypeParamConstraintContext {
        ...
        this.enterRule(localContext, 158, Stage6Parser.RULE_typeParamConstraint);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1049;
    ...
    public typeParamDefault(): TypeParamDefaultContext {
        ...
        this.enterRule(localContext, 160, Stage6Parser.RULE_typeParamDefault);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1054;
            this.match(Stage6Parser.LPAREN);
            this.state = 1055;
            this.match(Stage6Parser.DEFAULT);
            this.state = 1056;
            this.typeExpr();
            this.state = 1057;
            this.match(Stage6Parser.RPAREN);
    ...
    public assign(): AssignContext {
        ...
        this.enterRule(localContext, 162, Stage6Parser.RULE_assign);
        try {
            this.state = 1071;
            this.errorHandler.sync(this);
    ...
    public switchForm(): SwitchFormContext {
        ...
        this.enterRule(localContext, 164, Stage6Parser.RULE_switchForm);
        let _la: number;
        try {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1074;
            this.match(Stage6Parser.SWITCH);
            this.state = 1075;
            this.expression();
            this.state = 1079;
            this.errorHandler.sync(this);
    ...
    public caseClause(): CaseClauseContext {
        ...
        this.enterRule(localContext, 166, Stage6Parser.RULE_caseClause);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public defaultClause(): DefaultClauseContext {
        ...
        this.enterRule(localContext, 168, Stage6Parser.RULE_defaultClause);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public forForm(): ForFormContext {
        ...
        this.enterRule(localContext, 170, Stage6Parser.RULE_forForm);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public forInForm(): ForInFormContext {
        ...
        this.enterRule(localContext, 172, Stage6Parser.RULE_forInForm);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public forOfForm(): ForOfFormContext {
        ...
        this.enterRule(localContext, 174, Stage6Parser.RULE_forOfForm);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public forAwaitForm(): ForAwaitFormContext {
        ...
        this.enterRule(localContext, 176, Stage6Parser.RULE_forAwaitForm);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1146;
            this.match(Stage6Parser.FORAWAIT);
            this.state = 1147;
            this.match(Stage6Parser.IDENTIFIER);
            this.state = 1148;
            this.expression();
    ...
    public expression(): ExpressionContext {
        ...
        this.enterRule(localContext, 178, Stage6Parser.RULE_expression);
        try {
            this.state = 1192;
            this.errorHandler.sync(this);
    ...
    public thisExpr(): ThisExprContext {
        ...
        this.enterRule(localContext, 180, Stage6Parser.RULE_thisExpr);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1194;
            this.match(Stage6Parser.THIS);
            }
        }
        catch (re) {
            if (re instanceof antlr.RecognitionException) {
    ...
    public superExpr(): SuperExprContext {
        ...
        this.enterRule(localContext, 182, Stage6Parser.RULE_superExpr);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1196;
            this.match(Stage6Parser.SUPER);
            }
        }
        catch (re) {
            if (re instanceof antlr.RecognitionException) {
    ...
    public superConstructorCall(): SuperConstructorCallContext {
        ...
        this.enterRule(localContext, 184, Stage6Parser.RULE_superConstructorCall);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public superMethodCall(): SuperMethodCallContext {
        ...
        this.enterRule(localContext, 186, Stage6Parser.RULE_superMethodCall);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1209;
            this.match(Stage6Parser.SUPER_METHOD);
            this.state = 1210;
            this.match(Stage6Parser.IDENTIFIER);
            this.state = 1214;
            this.errorHandler.sync(this);
    ...
    public typeofExpr(): TypeofExprContext {
        ...
        this.enterRule(localContext, 188, Stage6Parser.RULE_typeofExpr);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1219;
    ...
    public typeAssert(): TypeAssertContext {
        ...
        this.enterRule(localContext, 190, Stage6Parser.RULE_typeAssert);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1224;
            this.match(Stage6Parser.LPAREN);
            this.state = 1225;
            this.match(Stage6Parser.TYPE_AS);
            this.state = 1226;
            this.expression();
            this.state = 1227;
            this.typeExpr();
    ...
    public lambda(): LambdaContext {
        ...
        this.enterRule(localContext, 192, Stage6Parser.RULE_lambda);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1231;
            this.match(Stage6Parser.LAMBDA);
            this.state = 1232;
            this.fnSignature();
            this.state = 1236;
            this.errorHandler.sync(this);
    ...
    public fn(): FnContext {
        ...
        this.enterRule(localContext, 194, Stage6Parser.RULE_fn);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public asyncLambda(): AsyncLambdaContext {
        ...
        this.enterRule(localContext, 196, Stage6Parser.RULE_asyncLambda);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1253;
            this.match(Stage6Parser.ASYNC_LAMBDA);
            this.state = 1254;
            this.fnSignature();
            this.state = 1258;
            this.errorHandler.sync(this);
    ...
    public asyncFn(): AsyncFnContext {
        ...
        this.enterRule(localContext, 198, Stage6Parser.RULE_asyncFn);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1264;
            this.match(Stage6Parser.ASYNC_FN);
            this.state = 1265;
            this.fnSignature();
            this.state = 1269;
            this.errorHandler.sync(this);
    ...
    public generatorFn(): GeneratorFnContext {
        ...
        this.enterRule(localContext, 200, Stage6Parser.RULE_generatorFn);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1275;
            this.match(Stage6Parser.GENERATOR_FN);
            this.state = 1276;
            this.fnSignature();
            this.state = 1280;
            this.errorHandler.sync(this);
    ...
    public asyncGeneratorFn(): AsyncGeneratorFnContext {
        ...
        this.enterRule(localContext, 202, Stage6Parser.RULE_asyncGeneratorFn);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1286;
            this.match(Stage6Parser.ASYNC_GENERATOR_FN);
            this.state = 1287;
            this.fnSignature();
            this.state = 1291;
            this.errorHandler.sync(this);
    ...
    public awaitExpr(): AwaitExprContext {
        ...
        this.enterRule(localContext, 204, Stage6Parser.RULE_awaitExpr);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1296;
    ...
    public yieldExpr(): YieldExprContext {
        ...
        this.enterRule(localContext, 206, Stage6Parser.RULE_yieldExpr);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public yieldStarExpr(): YieldStarExprContext {
        ...
        this.enterRule(localContext, 208, Stage6Parser.RULE_yieldStarExpr);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1308;
            this.match(Stage6Parser.LPAREN);
            this.state = 1309;
            this.match(Stage6Parser.YIELD_STAR);
            this.state = 1310;
            this.expression();
            this.state = 1311;
            this.match(Stage6Parser.RPAREN);
    ...
    public bindExpr(): BindExprContext {
        ...
        this.enterRule(localContext, 210, Stage6Parser.RULE_bindExpr);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public methodCallExpr(): MethodCallExprContext {
        ...
        this.enterRule(localContext, 212, Stage6Parser.RULE_methodCallExpr);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1326;
            this.match(Stage6Parser.METHOD_CALL);
            this.state = 1327;
            this.expression();
            this.state = 1328;
            this.expression();
    ...
    public ternary(): TernaryContext {
        ...
        this.enterRule(localContext, 214, Stage6Parser.RULE_ternary);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1337;
            this.match(Stage6Parser.LPAREN);
            this.state = 1338;
            this.match(Stage6Parser.TERNARY);
            this.state = 1339;
            this.expression();
            this.state = 1340;
            this.expression();
    ...
    public condExpr(): CondExprContext {
        ...
        this.enterRule(localContext, 216, Stage6Parser.RULE_condExpr);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public newForm(): NewFormContext {
        ...
        this.enterRule(localContext, 218, Stage6Parser.RULE_newForm);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public objectExpr(): ObjectExprContext {
        ...
        this.enterRule(localContext, 220, Stage6Parser.RULE_objectExpr);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1370;
            this.match(Stage6Parser.OBJECT);
            this.state = 1374;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            while (_la === 2) {
    ...
    public objectField(): ObjectFieldContext {
        ...
        this.enterRule(localContext, 222, Stage6Parser.RULE_objectField);
        try {
            this.state = 1392;
            this.errorHandler.sync(this);
    ...
    public methodDef(): MethodDefContext {
        ...
        this.enterRule(localContext, 224, Stage6Parser.RULE_methodDef);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public arrayExpr(): ArrayExprContext {
        ...
        this.enterRule(localContext, 226, Stage6Parser.RULE_arrayExpr);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public templateExpr(): TemplateExprContext {
        ...
        this.enterRule(localContext, 228, Stage6Parser.RULE_templateExpr);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1416;
            this.match(Stage6Parser.TEMPLATE);
            this.state = 1419;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            do {
    ...
    public propKey(): PropKeyContext {
        ...
        this.enterRule(localContext, 230, Stage6Parser.RULE_propKey);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public propAccess(): PropAccessContext {
        ...
        this.enterRule(localContext, 232, Stage6Parser.RULE_propAccess);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1427;
    ...
    public indexAccess(): IndexAccessContext {
        ...
        this.enterRule(localContext, 234, Stage6Parser.RULE_indexAccess);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1433;
    ...
    public quasiquote(): QuasiquoteContext {
        ...
        this.enterRule(localContext, 236, Stage6Parser.RULE_quasiquote);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public unquote(): UnquoteContext {
        ...
        this.enterRule(localContext, 238, Stage6Parser.RULE_unquote);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1444;
            this.match(Stage6Parser.LPAREN);
            this.state = 1445;
            this.match(Stage6Parser.UNQUOTE);
            this.state = 1446;
            this.expression();
            this.state = 1447;
            this.match(Stage6Parser.RPAREN);
    ...
    public unquoteSplicing(): UnquoteSplicingContext {
        ...
        this.enterRule(localContext, 240, Stage6Parser.RULE_unquoteSplicing);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1449;
            this.match(Stage6Parser.LPAREN);
            this.state = 1450;
            this.match(Stage6Parser.UNQUOTE_SPLICING);
            this.state = 1451;
            this.expression();
            this.state = 1452;
            this.match(Stage6Parser.RPAREN);
    ...
    public optChain(): OptChainContext {
        ...
        this.enterRule(localContext, 242, Stage6Parser.RULE_optChain);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1454;
            this.match(Stage6Parser.LPAREN);
            this.state = 1455;
            this.match(Stage6Parser.OPTCHAIN);
            this.state = 1456;
            this.expression();
            this.state = 1457;
            this.propKey();
    ...
    public optChainIndex(): OptChainIndexContext {
        ...
        this.enterRule(localContext, 244, Stage6Parser.RULE_optChainIndex);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1460;
            this.match(Stage6Parser.LPAREN);
            this.state = 1461;
            this.match(Stage6Parser.OPTCHAIN_INDEX);
            this.state = 1462;
            this.expression();
            this.state = 1463;
            this.expression();
    ...
    public nullCoalesce(): NullCoalesceContext {
        ...
        this.enterRule(localContext, 246, Stage6Parser.RULE_nullCoalesce);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 1466;
            this.match(Stage6Parser.LPAREN);
            this.state = 1467;
            this.match(Stage6Parser.NULLCOAL);
            this.state = 1468;
            this.expression();
            this.state = 1469;
            this.expression();
    ...
    public call(): CallContext {
        ...
        this.enterRule(localContext, 248, Stage6Parser.RULE_call);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public typeArgs(): TypeArgsContext {
        ...
        this.enterRule(localContext, 250, Stage6Parser.RULE_typeArgs);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
            ...
            this.match(Stage6Parser.LPAREN);
            this.state = 1486;
            this.match(Stage6Parser.TYPE_ARGS);
            this.state = 1488;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            do {
    ...
    public fnSignature(): FnSignatureContext {
        ...
        this.enterRule(localContext, 252, Stage6Parser.RULE_fnSignature);
        let _la: number;
        try {
            let alternative: number;
            this.state = 1525;
    ...
    public param(): ParamContext {
        ...
        this.enterRule(localContext, 254, Stage6Parser.RULE_param);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public restParam(): RestParamContext {
        ...
        this.enterRule(localContext, 256, Stage6Parser.RULE_restParam);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public literal(): LiteralContext {
        ...
        this.enterRule(localContext, 258, Stage6Parser.RULE_literal);
        let _la: number;
        try {
            this.enterOuterAlt(localContext, 1);
            {
    ...
    public static get _ATN(): antlr.ATN {
        if (!Stage6Parser.__ATN) {
            Stage6Parser.__ATN = new antlr.ATNDeserializer().deserialize(Stage6Parser._serializedATN);
        }

        return Stage6Parser.__ATN;
    }


    private static readonly vocabulary = new antlr.Vocabulary(Stage6Parser.literalNames, Stage6Parser.symbolicNames, []);

    public override get vocabulary(): antlr.Vocabulary {
        return Stage6Parser.vocabulary;
    }

    private static readonly decisionsToDFA = Stage6Parser._ATN.decisionToState.map( (ds: antlr.DecisionState, index: number) => new antlr.DFA(ds, index) );
}
...
export class ProgramContext extends antlr.ParserRuleContext {
    ...
    public LPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.LPAREN, 0)!;
    }
    public PROGRAM(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.PROGRAM, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    public topLevel(): TopLevelContext[];
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_program;
    }
    public override enterRule(listener: Stage6Listener): void {
        if(listener.enterProgram) {
             listener.enterProgram(this);
        }
    }
    public override exitRule(listener: Stage6Listener): void {
...
export class TopLevelContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_topLevel;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class DefmacroContext extends antlr.ParserRuleContext {
    ...
    public DEFMACRO(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.DEFMACRO, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    public fnSignature(): FnSignatureContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_defmacro;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class MacroTimeFnDefContext extends antlr.ParserRuleContext {
    ...
    public MACRO_TIME_ATTR(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.MACRO_TIME_ATTR, 0)!;
    }
    public topLevelLet(): TopLevelLetContext | null {
        return this.getRuleContext(0, TopLevelLetContext);
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_macroTimeFnDef;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TopLevelLetContext extends antlr.ParserRuleContext {
    ...
    public LET(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.LET, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_topLevelLet;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TopLevelConstContext extends antlr.ParserRuleContext {
    ...
    public CONST(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.CONST, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_topLevelConst;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class MetaAnnotationContext extends antlr.ParserRuleContext {
    ...
    public CARET(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.CARET, 0)!;
    }
    public KEYWORD(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.KEYWORD, 0)!;
    }
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_metaAnnotation;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeAliasContext extends antlr.ParserRuleContext {
    ...
    public TYPE(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.TYPE, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeAlias;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class InterfaceDefContext extends antlr.ParserRuleContext {
    ...
    public INTERFACE(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.INTERFACE, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_interfaceDef;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class InterfaceExtendsContext extends antlr.ParserRuleContext {
    ...
    public EXTENDS(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.EXTENDS, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_interfaceExtends;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ClassDefContext extends antlr.ParserRuleContext {
    ...
    public CLASS(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.CLASS, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_classDef;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class AnonClassDefContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_anonClassDef;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ClassExtendsContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_classExtends;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ClassImplementsContext extends antlr.ParserRuleContext {
    ...
    public IMPLEMENTS(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IMPLEMENTS, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_classImplements;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ClassBodyContext extends antlr.ParserRuleContext {
    ...
    public CLASS_BODY(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.CLASS_BODY, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_classBody;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ClassElementContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_classElement;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ModifierContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_modifier;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class FieldDefContext extends antlr.ParserRuleContext {
    ...
    public FIELD(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.FIELD, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public COLON(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.COLON, 0);
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_fieldDef;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ConstructorDefContext extends antlr.ParserRuleContext {
    ...
    public CONSTRUCTOR(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.CONSTRUCTOR, 0)!;
    }
    public fnSignatureTyped(): FnSignatureTypedContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_constructorDef;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ClassMethodDefContext extends antlr.ParserRuleContext {
    ...
    public METHOD(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.METHOD, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_classMethodDef;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class AbstractMethodDefContext extends antlr.ParserRuleContext {
    ...
    public ABSTRACT_METHOD(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.ABSTRACT_METHOD, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_abstractMethodDef;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class GetterDefContext extends antlr.ParserRuleContext {
    ...
    public GET(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.GET, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_getterDef;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class SetterDefContext extends antlr.ParserRuleContext {
    ...
    public SETPROP(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.SETPROP, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_setterDef;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypedParamContext extends antlr.ParserRuleContext {
    ...
    public OPTIONAL(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.OPTIONAL, 0);
    }
    public COLON(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.COLON, 0);
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typedParam;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class FnSignatureTypedContext extends antlr.ParserRuleContext {
    ...
    public LPAREN(i?: number): antlr.TerminalNode | null | antlr.TerminalNode[] {
    	if (i === undefined) {
    		return this.getTokens(Stage6Parser.LPAREN);
    	} else {
    		return this.getToken(Stage6Parser.LPAREN, i);
    	}
    }
    public RPAREN(): antlr.TerminalNode[];
    ...
    public RPAREN(i?: number): antlr.TerminalNode | null | antlr.TerminalNode[] {
    	if (i === undefined) {
    		return this.getTokens(Stage6Parser.RPAREN);
    	} else {
    		return this.getToken(Stage6Parser.RPAREN, i);
    	}
    }
    public typedParam(): TypedParamContext[];
    ...
    public RETURNS(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.RETURNS, 0);
    }
    public typeExpr(): TypeExprContext | null {
        return this.getRuleContext(0, TypeExprContext);
    }
    ...
    public COMMA(i?: number): antlr.TerminalNode | null | antlr.TerminalNode[] {
    	if (i === undefined) {
    		return this.getTokens(Stage6Parser.COMMA);
    	} else {
    		return this.getToken(Stage6Parser.COMMA, i);
    	}
    }
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_fnSignatureTyped;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class StatementContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_statement;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class LetStarContext extends antlr.ParserRuleContext {
    ...
    public LETSTAR(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.LETSTAR, 0)!;
    }
    public RPAREN(): antlr.TerminalNode[];
    public RPAREN(i: number): antlr.TerminalNode | null;
    public RPAREN(i?: number): antlr.TerminalNode | null | antlr.TerminalNode[] {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_letStar;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class LetStmtContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_letStmt;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ConstStarContext extends antlr.ParserRuleContext {
    ...
    public CONSTSTAR(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.CONSTSTAR, 0)!;
    }
    public RPAREN(): antlr.TerminalNode[];
    public RPAREN(i: number): antlr.TerminalNode | null;
    public RPAREN(i?: number): antlr.TerminalNode | null | antlr.TerminalNode[] {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_constStar;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ConstStmtContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_constStmt;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class IfFormContext extends antlr.ParserRuleContext {
    ...
    public IF(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IF, 0)!;
    }
    public expression(): ExpressionContext {
        return this.getRuleContext(0, ExpressionContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_ifForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class WhileFormContext extends antlr.ParserRuleContext {
    ...
    public WHILE(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.WHILE, 0)!;
    }
    public expression(): ExpressionContext {
        return this.getRuleContext(0, ExpressionContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_whileForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class BlockContext extends antlr.ParserRuleContext {
    ...
    public BEGIN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.BEGIN, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_block;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ReturnFormContext extends antlr.ParserRuleContext {
    ...
    public RETURN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RETURN, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_returnForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ThrowFormContext extends antlr.ParserRuleContext {
    ...
    public THROW(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.THROW, 0)!;
    }
    public expression(): ExpressionContext {
        return this.getRuleContext(0, ExpressionContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_throwForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ImportFormContext extends antlr.ParserRuleContext {
    ...
    public IMPORT(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IMPORT, 0)!;
    }
    public STRING(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.STRING, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_importForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ImportTypeFormContext extends antlr.ParserRuleContext {
    ...
    public IMPORT_TYPE(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IMPORT_TYPE, 0)!;
    }
    public importTypeSpec(): ImportTypeSpecContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_importTypeForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ImportTypeSpecContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_importTypeSpec;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ImportTypeNameContext extends antlr.ParserRuleContext {
    ...
    public IDENTIFIER(i?: number): antlr.TerminalNode | null | antlr.TerminalNode[] {
    	if (i === undefined) {
    		return this.getTokens(Stage6Parser.IDENTIFIER);
    	} else {
    		return this.getToken(Stage6Parser.IDENTIFIER, i);
    	}
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_importTypeName;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExportFormContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_exportForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExportBindingContext extends antlr.ParserRuleContext {
    ...
    public EXPORT(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.EXPORT, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_exportBinding;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExportDefaultContext extends antlr.ParserRuleContext {
    ...
    public EXPORT_DEFAULT(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.EXPORT_DEFAULT, 0)!;
    }
    public classDef(): ClassDefContext | null {
        return this.getRuleContext(0, ClassDefContext);
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_exportDefault;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExportNamedContext extends antlr.ParserRuleContext {
    ...
    public EXPORT_NAMED(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.EXPORT_NAMED, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_exportNamed;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExportNamePairContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_exportNamePair;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExportFromContext extends antlr.ParserRuleContext {
    ...
    public EXPORT_FROM(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.EXPORT_FROM, 0)!;
    }
    public STRING(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.STRING, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_exportFrom;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExportAllFromContext extends antlr.ParserRuleContext {
    ...
    public EXPORT_ALL_FROM(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.EXPORT_ALL_FROM, 0)!;
    }
    public STRING(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.STRING, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_exportAllFrom;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExportNsFromFormContext extends antlr.ParserRuleContext {
    ...
    public EXPORT_NS_FROM(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.EXPORT_NS_FROM, 0)!;
    }
    public STRING(): antlr.TerminalNode[];
    public STRING(i: number): antlr.TerminalNode | null;
    public STRING(i?: number): antlr.TerminalNode | null | antlr.TerminalNode[] {
    	if (i === undefined) {
    		return this.getTokens(Stage6Parser.STRING);
    	} else {
    		return this.getToken(Stage6Parser.STRING, i);
    	}
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_exportNsFromForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExportTypeFormContext extends antlr.ParserRuleContext {
    ...
    public EXPORT_TYPE(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.EXPORT_TYPE, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_exportTypeForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExportTypeFromFormContext extends antlr.ParserRuleContext {
    ...
    public EXPORT_TYPE_FROM(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.EXPORT_TYPE_FROM, 0)!;
    }
    public STRING(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.STRING, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_exportTypeFromForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExportTypeAllFromFormContext extends antlr.ParserRuleContext {
    ...
    public EXPORT_TYPE_ALL_FROM(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.EXPORT_TYPE_ALL_FROM, 0)!;
    }
    public STRING(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.STRING, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_exportTypeAllFromForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExportDeclFormContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_exportDeclForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class StarBindingContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_starBinding;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class SingleBindingContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_singleBinding;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeExprContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeUnionContext extends antlr.ParserRuleContext {
    ...
    public UNION(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.UNION, 0)!;
    }
    public typeExpr(): TypeExprContext[];
    public typeExpr(i: number): TypeExprContext | null;
    public typeExpr(i?: number): TypeExprContext[] | TypeExprContext | null {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeUnion;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeIntersectionContext extends antlr.ParserRuleContext {
    ...
    public INTERSECT(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.INTERSECT, 0)!;
    }
    public typeExpr(): TypeExprContext[];
    public typeExpr(i: number): TypeExprContext | null;
    public typeExpr(i?: number): TypeExprContext[] | TypeExprContext | null {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeIntersection;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeArrayContext extends antlr.ParserRuleContext {
    ...
    public TYPE_ARRAY(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.TYPE_ARRAY, 0)!;
    }
    public typeExpr(): TypeExprContext {
        return this.getRuleContext(0, TypeExprContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeArray;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeTupleContext extends antlr.ParserRuleContext {
    ...
    public TUPLE(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.TUPLE, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeTuple;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeTupleElementContext extends antlr.ParserRuleContext {
    ...
    public REST(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.REST, 0);
    }
    public typeExpr(): TypeExprContext {
        return this.getRuleContext(0, TypeExprContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeTupleElement;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeFunctionContext extends antlr.ParserRuleContext {
    ...
    public TYPEFN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.TYPEFN, 0)!;
    }
    public RPAREN(): antlr.TerminalNode[];
    public RPAREN(i: number): antlr.TerminalNode | null;
    public RPAREN(i?: number): antlr.TerminalNode | null | antlr.TerminalNode[] {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeFunction;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeFnParamContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeFnParam;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeObjectContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeObject;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypePropContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeProp;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class PropModifierContext extends antlr.ParserRuleContext {
    ...
    public READONLY(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.READONLY, 0)!;
    }
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_propModifier;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeLiteralContext extends antlr.ParserRuleContext {
    ...
    public LIT(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.LIT, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public NUMBER(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.NUMBER, 0);
    }
    public BOOLEAN(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.BOOLEAN, 0);
    }
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeLiteral;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeKeyofContext extends antlr.ParserRuleContext {
    ...
    public KEYOF(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.KEYOF, 0)!;
    }
    public typeExpr(): TypeExprContext {
        return this.getRuleContext(0, TypeExprContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeKeyof;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeTypeofContext extends antlr.ParserRuleContext {
    ...
    public TYPEOF(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.TYPEOF, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeTypeof;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeIndexAccessContext extends antlr.ParserRuleContext {
    ...
    public INDEX(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.INDEX, 0)!;
    }
    public typeExpr(): TypeExprContext[];
    public typeExpr(i: number): TypeExprContext | null;
    public typeExpr(i?: number): TypeExprContext[] | TypeExprContext | null {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeIndexAccess;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeConditionalContext extends antlr.ParserRuleContext {
    ...
    public COND(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.COND, 0)!;
    }
    public typeExpr(): TypeExprContext[];
    public typeExpr(i: number): TypeExprContext | null;
    public typeExpr(i?: number): TypeExprContext[] | TypeExprContext | null {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeConditional;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeInferContext extends antlr.ParserRuleContext {
    ...
    public INFER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.INFER, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeInfer;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeMappedContext extends antlr.ParserRuleContext {
    ...
    public MAPPED(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.MAPPED, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeMapped;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class MappedModifiersContext extends antlr.ParserRuleContext {
    ...
    public MODIFIERS(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.MODIFIERS, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_mappedModifiers;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class MappedModifierContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_mappedModifier;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeTemplateLiteralContext extends antlr.ParserRuleContext {
    ...
    public TYPE_TEMPLATE(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.TYPE_TEMPLATE, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeTemplateLiteral;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TemplatePartContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_templatePart;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeApplicationContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeApplication;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeParamsContext extends antlr.ParserRuleContext {
    ...
    public TYPE_PARAMS(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.TYPE_PARAMS, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeParams;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeParamDeclContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeParamDecl;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeParamConstraintContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeParamConstraint;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeParamDefaultContext extends antlr.ParserRuleContext {
    ...
    public DEFAULT(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.DEFAULT, 0)!;
    }
    public typeExpr(): TypeExprContext {
        return this.getRuleContext(0, TypeExprContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeParamDefault;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class AssignContext extends antlr.ParserRuleContext {
    ...
    public SET(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.SET, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.IDENTIFIER, 0);
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_assign;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class SwitchFormContext extends antlr.ParserRuleContext {
    ...
    public SWITCH(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.SWITCH, 0)!;
    }
    public expression(): ExpressionContext {
        return this.getRuleContext(0, ExpressionContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_switchForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class CaseClauseContext extends antlr.ParserRuleContext {
    ...
    public CASE(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.CASE, 0)!;
    }
    public expression(): ExpressionContext {
        return this.getRuleContext(0, ExpressionContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_caseClause;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class DefaultClauseContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_defaultClause;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ForFormContext extends antlr.ParserRuleContext {
    ...
    public FOR(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.FOR, 0)!;
    }
    public letStmt(): LetStmtContext {
        return this.getRuleContext(0, LetStmtContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_forForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ForInFormContext extends antlr.ParserRuleContext {
    ...
    public FORIN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.FORIN, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_forInForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ForOfFormContext extends antlr.ParserRuleContext {
    ...
    public FOROF(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.FOROF, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_forOfForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ForAwaitFormContext extends antlr.ParserRuleContext {
    ...
    public FORAWAIT(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.FORAWAIT, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_forAwaitForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ExpressionContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_expression;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ThisExprContext extends antlr.ParserRuleContext {
    ...
    public THIS(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.THIS, 0)!;
    }
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_thisExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class SuperExprContext extends antlr.ParserRuleContext {
    ...
    public SUPER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.SUPER, 0)!;
    }
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_superExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class SuperConstructorCallContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_superConstructorCall;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class SuperMethodCallContext extends antlr.ParserRuleContext {
    ...
    public SUPER_METHOD(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.SUPER_METHOD, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_superMethodCall;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeofExprContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeofExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeAssertContext extends antlr.ParserRuleContext {
    ...
    public TYPE_AS(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.TYPE_AS, 0)!;
    }
    public expression(): ExpressionContext {
        return this.getRuleContext(0, ExpressionContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeAssert;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class LambdaContext extends antlr.ParserRuleContext {
    ...
    public LAMBDA(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.LAMBDA, 0)!;
    }
    public fnSignature(): FnSignatureContext {
        return this.getRuleContext(0, FnSignatureContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_lambda;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class FnContext extends antlr.ParserRuleContext {
    ...
    public FN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.FN, 0)!;
    }
    public fnSignature(): FnSignatureContext {
        return this.getRuleContext(0, FnSignatureContext)!;
    }
...
export class AsyncLambdaContext extends antlr.ParserRuleContext {
    ...
    public ASYNC_LAMBDA(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.ASYNC_LAMBDA, 0)!;
    }
    public fnSignature(): FnSignatureContext {
        return this.getRuleContext(0, FnSignatureContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_asyncLambda;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class AsyncFnContext extends antlr.ParserRuleContext {
    ...
    public ASYNC_FN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.ASYNC_FN, 0)!;
    }
    public fnSignature(): FnSignatureContext {
        return this.getRuleContext(0, FnSignatureContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_asyncFn;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class GeneratorFnContext extends antlr.ParserRuleContext {
    ...
    public GENERATOR_FN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.GENERATOR_FN, 0)!;
    }
    public fnSignature(): FnSignatureContext {
        return this.getRuleContext(0, FnSignatureContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_generatorFn;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class AsyncGeneratorFnContext extends antlr.ParserRuleContext {
    ...
    public ASYNC_GENERATOR_FN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.ASYNC_GENERATOR_FN, 0)!;
    }
    public fnSignature(): FnSignatureContext {
        return this.getRuleContext(0, FnSignatureContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_asyncGeneratorFn;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class AwaitExprContext extends antlr.ParserRuleContext {
    ...
    public AWAIT(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.AWAIT, 0)!;
    }
    public expression(): ExpressionContext {
        return this.getRuleContext(0, ExpressionContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_awaitExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class YieldExprContext extends antlr.ParserRuleContext {
    ...
    public YIELD(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.YIELD, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_yieldExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class YieldStarExprContext extends antlr.ParserRuleContext {
    ...
    public YIELD_STAR(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.YIELD_STAR, 0)!;
    }
    public expression(): ExpressionContext {
        return this.getRuleContext(0, ExpressionContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_yieldStarExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class BindExprContext extends antlr.ParserRuleContext {
    ...
    public BIND(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.BIND, 0)!;
    }
    public expression(): ExpressionContext[];
    public expression(i: number): ExpressionContext | null;
    public expression(i?: number): ExpressionContext[] | ExpressionContext | null {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_bindExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class MethodCallExprContext extends antlr.ParserRuleContext {
    ...
    public METHOD_CALL(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.METHOD_CALL, 0)!;
    }
    public expression(): ExpressionContext[];
    public expression(i: number): ExpressionContext | null;
    public expression(i?: number): ExpressionContext[] | ExpressionContext | null {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_methodCallExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TernaryContext extends antlr.ParserRuleContext {
    ...
    public TERNARY(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.TERNARY, 0)!;
    }
    public expression(): ExpressionContext[];
    public expression(i: number): ExpressionContext | null;
    public expression(i?: number): ExpressionContext[] | ExpressionContext | null {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_ternary;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class CondExprContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_condExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class NewFormContext extends antlr.ParserRuleContext {
    ...
    public NEW(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.NEW, 0)!;
    }
    public IDENTIFIER(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.IDENTIFIER, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_newForm;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ObjectExprContext extends antlr.ParserRuleContext {
    ...
    public OBJECT(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.OBJECT, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_objectExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ObjectFieldContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_objectField;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class MethodDefContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_methodDef;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ArrayExprContext extends antlr.ParserRuleContext {
    ...
    public ARRAY(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.ARRAY, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_arrayExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TemplateExprContext extends antlr.ParserRuleContext {
    ...
    public TEMPLATE(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.TEMPLATE, 0)!;
    }
    public RPAREN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.RPAREN, 0)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_templateExpr;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class PropKeyContext extends antlr.ParserRuleContext {
    ...
    public QUASI(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.QUASI, 0);
    }
    public QUOTE(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.QUOTE, 0);
    }
    public UNQUOTE_SPLICING(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.UNQUOTE_SPLICING, 0);
    }
    public UNQUOTE(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.UNQUOTE, 0);
    }
    ...
    public TYPE_ARGS(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.TYPE_ARGS, 0);
    }
    ...
    public NULL(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.NULL, 0);
    }
    public UNDEFINED(): antlr.TerminalNode | null {
        return this.getToken(Stage6Parser.UNDEFINED, 0);
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_propKey;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class PropAccessContext extends antlr.ParserRuleContext {
    ...
    public DOT(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.DOT, 0)!;
    }
    public expression(): ExpressionContext {
        return this.getRuleContext(0, ExpressionContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_propAccess;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class IndexAccessContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_indexAccess;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class QuasiquoteContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_quasiquote;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class UnquoteContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_unquote;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class UnquoteSplicingContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_unquoteSplicing;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class OptChainContext extends antlr.ParserRuleContext {
    ...
    public OPTCHAIN(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.OPTCHAIN, 0)!;
    }
    public expression(): ExpressionContext {
        return this.getRuleContext(0, ExpressionContext)!;
    }
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_optChain;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class OptChainIndexContext extends antlr.ParserRuleContext {
    ...
    public OPTCHAIN_INDEX(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.OPTCHAIN_INDEX, 0)!;
    }
    public expression(): ExpressionContext[];
    public expression(i: number): ExpressionContext | null;
    public expression(i?: number): ExpressionContext[] | ExpressionContext | null {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_optChainIndex;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class NullCoalesceContext extends antlr.ParserRuleContext {
    ...
    public NULLCOAL(): antlr.TerminalNode {
        return this.getToken(Stage6Parser.NULLCOAL, 0)!;
    }
    public expression(): ExpressionContext[];
    public expression(i: number): ExpressionContext | null;
    public expression(i?: number): ExpressionContext[] | ExpressionContext | null {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_nullCoalesce;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class TypeArgsContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_typeArgs;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class FnSignatureContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_fnSignature;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class ParamContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_param;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class RestParamContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_restParam;
    }
    public override enterRule(listener: Stage6Listener): void {
...
export class LiteralContext extends antlr.ParserRuleContext {
    ...
    public override get ruleIndex(): number {
        return Stage6Parser.RULE_literal;
    }
    public override enterRule(listener: Stage6Listener): void {
