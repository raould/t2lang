...
1. Codegen (t2lang-phase0/src/codegen/tsCodegen.ts)
...
2. Typechecker (t2lang-phase0/src/typecheck/typeChecker.ts)
...
4. Tests & Docs
   - Update `t2lang-phase0/Phase0_Syntax_and_Grammar.md` to mention allowed operator forms and boolean literals as valid `expr` heads.
   - Add unit tests (`t2lang-phase0/tests/unit`) covering:
