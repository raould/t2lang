/**
 * Tests for DESIGN.md Decision 1: Backtick strings removed from Stage6.
 *
 * Decision: BACKTICK_STRING is removed from the Stage6 grammar.
...
// (the dead code path was removed from Stage6-ast.s3d), and the grammar rules
