...
import { makeMacroEnv, collectMacros } from '#src/Stage10-macro-env';
import { expandAll, formatExpansionErrors } from '#src/Stage10-macro-expand';
import { spanTable, resetSpans, nextNodeId, registerSpan } from '#src/Stage10-spans';
