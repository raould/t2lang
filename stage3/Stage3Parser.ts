...
export class Stage3Parser extends antlr.Parser {
    ...
    public static readonly UNQUOTE_SPLICING = 22;
    public static readonly UNQUOTE = 23;
    public static readonly BOOLEAN = 24;
    public static readonly NULL = 25;
    public static readonly UNDEFINED = 26;
    public static readonly KEYWORD = 27;
    public static readonly NUMBER = 28;
    public static readonly STRING = 29;
    public static readonly MULTILINE_STRING = 30;
    ...
    public static readonly literalNames = [
        ...
        "'quote'", "'unquote-splicing'", "'unquote'", null, "'null'", "'undefined'"
    ];

    public static readonly symbolicNames = [
        null, "COMMENT", "LPAREN", "RPAREN", "COMMA", "PROGRAM", "LETSTAR", 
        "LET", "LAMBDA", "DEF", "DEFMACRO", "IF", "WHILE", "BEGIN", "RETURN", 
        "SET", "OBJECT", "ARRAY", "DOT", "INDEX", "QUASI", "QUOTE", "UNQUOTE_SPLICING", 
    ...
    public program(): ProgramContext {
        ...
        try {
            ...
            while ((((_la) & ~0x1F) === 0 && ((1 << _la) & 3204448260) !== 0)) {
                {
                {
                this.state = 56;
                this.topLevel();
    ...
    public ifForm(): IfFormContext {
        ...
        try {
            ...
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            if ((((_la) & ~0x1F) === 0 && ((1 << _la) & 3204448260) !== 0)) {
                {
                this.state = 124;
                this.statement();
                }
    ...
    public literal(): LiteralContext {
        ...
        try {
            ...
            this.state = 277;
            _la = this.tokenStream.LA(1);
            if(!((((_la) & ~0x1F) === 0 && ((1 << _la) & 922746880) !== 0))) {
            this.errorHandler.recoverInline(this);
            }
            else {
                this.errorHandler.reportMatch(this);
    ...
    public static readonly _serializedATN: number[] = [
        4,1,32,280,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,
        ...
        40,42,44,46,48,50,52,0,4,3,0,27,27,29,29,31,31,2,0,27,27,31,31,1,
        0,20,21,2,0,24,26,28,29,288,0,54,1,0,0,0,2,67,1,0,0,0,4,69,1,0,0,
        0,6,81,1,0,0,0,8,94,1,0,0,0,10,96,1,0,0,0,12,114,1,0,0,0,14,120,
        1,0,0,0,16,129,1,0,0,0,18,140,1,0,0,0,20,150,1,0,0,0,22,157,1,0,
        0,0,24,177,1,0,0,0,26,179,1,0,0,0,28,190,1,0,0,0,30,196,1,0,0,0,
        32,206,1,0,0,0,34,211,1,0,0,0,36,221,1,0,0,0,38,227,1,0,0,0,40,233,
        1,0,0,0,42,238,1,0,0,0,44,243,1,0,0,0,46,248,1,0,0,0,48,258,1,0,
        0,0,50,273,1,0,0,0,52,277,1,0,0,0,54,55,5,2,0,0,55,59,5,5,0,0,56,
        58,3,2,1,0,57,56,1,0,0,0,58,61,1,0,0,0,59,57,1,0,0,0,59,60,1,0,0,
        0,60,62,1,0,0,0,61,59,1,0,0,0,62,63,5,3,0,0,63,1,1,0,0,0,64,68,3,
        4,2,0,65,68,3,6,3,0,66,68,3,8,4,0,67,64,1,0,0,0,67,65,1,0,0,0,67,
        66,1,0,0,0,68,3,1,0,0,0,69,70,5,2,0,0,70,71,5,10,0,0,71,72,5,31,
        0,0,72,76,3,48,24,0,73,75,3,8,4,0,74,73,1,0,0,0,75,78,1,0,0,0,76,
        74,1,0,0,0,76,77,1,0,0,0,77,79,1,0,0,0,78,76,1,0,0,0,79,80,5,3,0,
        1,0,0,0,177,176,1,0,0,0,178,25,1,0,0,0,179,180,5,2,0,0,180,181,5,
        8,0,0,181,185,3,48,24,0,182,184,3,8,4,0,183,182,1,0,0,0,184,187,
        1,0,0,0,185,183,1,0,0,0,185,186,1,0,0,0,186,188,1,0,0,0,187,185,
        1,0,0,0,188,189,5,3,0,0,189,27,1,0,0,0,190,191,5,2,0,0,191,192,5,
        15,0,0,192,193,5,31,0,0,193,194,3,24,12,0,194,195,5,3,0,0,195,29,
        1,0,0,0,196,197,5,2,0,0,197,201,5,16,0,0,198,200,3,32,16,0,199,198,
        1,0,0,0,200,203,1,0,0,0,201,199,1,0,0,0,201,202,1,0,0,0,202,204,
        1,0,0,0,203,201,1,0,0,0,204,205,5,3,0,0,205,31,1,0,0,0,206,207,5,
        2,0,0,207,208,7,0,0,0,208,209,3,24,12,0,209,210,5,3,0,0,210,33,1,
        0,0,0,211,212,5,2,0,0,212,216,5,17,0,0,213,215,3,24,12,0,214,213,
        1,0,0,0,215,218,1,0,0,0,216,214,1,0,0,0,216,217,1,0,0,0,217,219,
        1,0,0,0,218,216,1,0,0,0,219,220,5,3,0,0,220,35,1,0,0,0,221,222,5,
        2,0,0,222,223,5,18,0,0,223,224,3,24,12,0,224,225,7,1,0,0,225,226,
        5,3,0,0,226,37,1,0,0,0,227,228,5,2,0,0,228,229,5,19,0,0,229,230,
        3,24,12,0,230,231,3,24,12,0,231,232,5,3,0,0,232,39,1,0,0,0,233,234,
        5,2,0,0,234,235,7,2,0,0,235,236,3,24,12,0,236,237,5,3,0,0,237,41,
        1,0,0,0,238,239,5,2,0,0,239,240,5,23,0,0,240,241,3,24,12,0,241,242,
        5,3,0,0,242,43,1,0,0,0,243,244,5,2,0,0,244,245,5,22,0,0,245,246,
        3,24,12,0,246,247,5,3,0,0,247,45,1,0,0,0,248,249,5,2,0,0,249,253,
        3,24,12,0,250,252,3,24,12,0,251,250,1,0,0,0,252,255,1,0,0,0,253,
        251,1,0,0,0,253,254,1,0,0,0,254,256,1,0,0,0,255,253,1,0,0,0,256,
        257,5,3,0,0,257,47,1,0,0,0,258,269,5,2,0,0,259,266,3,50,25,0,260,
        262,5,4,0,0,261,260,1,0,0,0,261,262,1,0,0,0,262,263,1,0,0,0,263,
        265,3,50,25,0,264,261,1,0,0,0,265,268,1,0,0,0,266,264,1,0,0,0,266,
        267,1,0,0,0,267,270,1,0,0,0,268,266,1,0,0,0,269,259,1,0,0,0,269,
        270,1,0,0,0,270,271,1,0,0,0,271,272,5,3,0,0,272,49,1,0,0,0,273,274,
        5,2,0,0,274,275,5,31,0,0,275,276,5,3,0,0,276,51,1,0,0,0,277,278,
        7,3,0,0,278,53,1,0,0,0,19,59,67,76,94,102,109,125,135,145,153,160,
        177,185,201,216,253,261,266,269
    ];
...
export class QuasiquoteContext extends antlr.ParserRuleContext {
    ...
    public QUOTE(): antlr.TerminalNode | null {
        return this.getToken(Stage3Parser.QUOTE, 0);
    }
    public override get ruleIndex(): number {
