...
* done: move cliHelper out of phase0/ into a new common/ workspace directory, and update phase0 and phase1 to use it from there.
* done: defmacro expansion is not working correctly at least from the CLI.
* done: make sure phase1 has build dependency on phase0 so that phase1 is never using stale phase0 code. (Added `phase0` dependency and `prebuild` script to run phase0 build before phase1.)
