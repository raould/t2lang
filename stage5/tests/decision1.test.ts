/**
 * Tests for DESIGN.md Decision 1: Backtick strings removed from Stage5.
 *
 * Decision: BACKTICK_STRING is removed from the Stage5 grammar.
...
// (the dead code path was removed from Stage5-ast.s3d), and the grammar rules
