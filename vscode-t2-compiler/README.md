...
2. `./t2lang-phase1/dist/cli.js` (t2lang project structure)
3. `./node_modules/t2lang-phase1/dist/cli.js`
...
1. Make sure the t2lang project is built (`npm run build` in t2lang-phase1)
