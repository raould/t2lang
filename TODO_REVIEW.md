...
├── t2lang-phase0/    # Core compiler (lexer, parser, resolver, typechecker, codegen)
├── t2lang-phase1/    # Sugar layer + macros (extends Phase0)
...
#### 12. **EBNF Grammar** 🟢
**TODO.md says:** "we need to define a grammar for t2lang-phase0 e.g. Extended Backus-Naur Form"  
