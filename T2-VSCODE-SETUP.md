...
```json
{
  "emeraldwalk.runonsave": {
    "commands": [
      {
        "match": "\\.t2$",
        "cmd": "node ${workspaceFolder}/t2lang-phase1/dist/cli.js ${file}"
      }
    ]
  }
}
  ...
  "tasks": [
    {
      ...
      "command": "node",
      "args": [
        "${workspaceFolder}/t2lang-phase1/dist/cli.js",
        "${file}"
      ],
      "presentation": {
        "reveal": "silent"
...
const t2tc = './t2lang-phase1/dist/cli.js';
...
```bash
cd t2lang-phase0 && npm install && npm run build
cd ../t2lang-phase1 && npm install && npm run build
